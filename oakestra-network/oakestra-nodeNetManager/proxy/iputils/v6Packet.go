...
func (packet *IPv6Packet) GetTransportLayer() TransportLayerProtocol {
	...
	logger.InfoLogger().Println(packet.IPv6.NextHeader)
	logger.InfoLogger().Println(packet.GetDestIP())
	logger.InfoLogger().Println(packet.GetSrcIP())
	logger.InfoLogger().Println(packet.GetLayer())
