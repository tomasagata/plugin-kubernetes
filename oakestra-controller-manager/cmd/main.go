...
import (
	...
	"oakestra/OakestraJob-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(oakestrav1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6f1ebf9e.oakestra.kubernetes",
	...
	if err = (&controller.OakestraJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OakestraJob")
		os.Exit(1)
	}
